...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    @livewireStyles
    <!-- Scripts -->
    <script src="{{asset('assets/js/jquery-1.12.4.minb8ff.js?ver=1.12.4')}}" defer></script>
    <script src="{{asset('assets/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4')}}" defer></script>
                    ...
                    @auth
                      @if (Auth::user()->user_type === 'admin')
                        <li class="menu-item menu-item-has-children parent">
                          <a title="Dashboard (Admin)" href="#">Dashboard (Admin)<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                        ...
                        @else
                          <li class="menu-item menu-item-has-children parent">
                            <a title="Dashboard" href="#">Dashboard<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            <ul class="submenu curency">
                              <li class="menu-item">
                                <a title="Pound (GBP)" href="#">Pound (GBP)</a>
                              </li>
